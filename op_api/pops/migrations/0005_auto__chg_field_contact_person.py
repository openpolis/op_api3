...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.person'
        db.alter_column(u'pops_contact', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pops.Person'], null=True))

    def backwards(self, orm):

        # Changing field 'Contact.person'
        db.alter_column(u'pops_contact', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['pops.Person']))
    ...
    models = {
        ...
        u'pops.contact': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pops.Person']", 'null': 'True'}),
