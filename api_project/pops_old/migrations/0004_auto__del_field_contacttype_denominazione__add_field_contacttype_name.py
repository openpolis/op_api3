...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ContactType.denominazione'
        db.delete_column(u'pops_contacttype', 'denominazione')

        # Adding field 'ContactType.name'
        db.add_column(u'pops_contacttype', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ContactType.denominazione'
        db.add_column(u'pops_contacttype', 'denominazione',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)

        # Deleting field 'ContactType.name'
        db.delete_column(u'pops_contacttype', 'name')
