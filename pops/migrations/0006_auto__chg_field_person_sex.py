...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.sex'
        db.alter_column(u'pops_person', 'sex', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

    def backwards(self, orm):

        # Changing field 'Person.sex'
        db.alter_column(u'pops_person', 'sex', self.gf('django.db.models.fields.CharField')(default='', max_length=1))
