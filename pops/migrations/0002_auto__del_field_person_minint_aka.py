...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Person.minint_aka'
        db.delete_column(u'pops_person', 'minint_aka')


    def backwards(self, orm):
        # Adding field 'Person.minint_aka'
        db.add_column(u'pops_person', 'minint_aka',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, unique=True, blank=True),
                      keep_default=False)
